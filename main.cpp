...
int main() {
	...
	//cout << n.eval_input_tokens("(function add1 (x) (+ x 1)) (map add1 (list 1 2 3 4))")->int_value << endl;
	...
	//(def a (list 1 2 3 4)) (foldl cons 0 a)

	//(def a (list 1 2 3)) (def b (list 4 5 6)) (def c (list 7 8 9)) (def d (list a b c)) (map rm_tail d)
